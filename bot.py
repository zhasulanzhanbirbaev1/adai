...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    intro = (
        ...
        "Я — *Adai*. Работаю как таргетолог и маркетолог в одном — "
        "только на базе ИИ, без выходных и в разы дешевле.\n\n"
        "Пока обычный таргетолог берёт 80–150k ₸ в месяц и работает "
        "руками — я делаю то же самое автоматически: придумываю, "
        "запускаю, оптимизирую.\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "🎨 *Маркетолог: создаю рекламные материалы*\n"
        "Баннеры, тексты объявлений, подписи к постам — "
        "3 готовых варианта под ваш бизнес за ~10 секунд.\n\n"
        "🎯 *Таргетолог: настраиваю и запускаю рекламу*\n"
        "Сам выбираю аудиторию, создаю кампанию в Facebook/Instagram "
        "и запускаю. Никаких кабинетов и настроек вручную.\n\n"
        "📊 *24/7: слежу и оптимизирую*\n"
        "Каждые 6 часов анализирую результаты: останавливаю убыточное, "
        "масштабирую рабочее. Вы просто получаете лиды.\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "*Для кого:*\n"
        "Стоматологии · Автосервисы · Салоны красоты · Кофейни "
        "· Фитнес · Автосалоны · Онлайн-школы · Цветочные\n\n"
        "💰 *Тарифы:* от 30 000 ₸/мес — дешевле любого таргетолога\n"
