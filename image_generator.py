...
Если заполнен оффер с цифрой — используй её в крюке. Если нет — строй крюк без цифры
(сильное утверждение, факт об услуге, конфликт с ожиданием). Не придумывай цифры от себя.
