...
ЗАПРЕЩЕНО писать цифры (цены, проценты, сроки) в hook_headline, subheadline, bullets и cta_button.
Строй крюки через: сильное утверждение, факт об услуге, конфликт с ожиданием, подарок без цены.
Оффер и цену из брифа используй только как контекст чтобы понять бизнес — в текст не выводи.
