...
Предложение с цифрой — желательно, но не обязательно. Если цифры нет — придумай типичную
цену / срок / скидку для этой ниши в Казахстане и используй её в крюке.
Если не указан конкретный товар/услуга И ниша не заполнена — вернуть:
